...
task 'regenerate', '', (done) ->
  regenExpected {
    ...
    'mappings': {
      ...
      'Microsoft.PolicyInsights': { basePath: 'policyinsights/resource-manager', tags: [ 'schema-policyinsights-2017-08-09-preview', 'schema-policyinsights-2017-10-17-preview', 'schema-policyinsights-2017-12-12-preview', 'schema-policyinsights-2018-04-04', 'schema-policyinsights-2018-07-01-preview', 'schema-policyinsights-2019-10-01' ]},
      ...
      'Microsoft.ServiceBus': { basePath: 'servicebus/resource-manager', tags: [ 'schema-servicebus-2014-09-01', 'schema-servicebus-2015-08-01', 'schema-servicebus-2017-04-01', 'schema-servicebus-2018-01-01-preview' ]},
      'Microsoft.ServiceFabric': { basePath: 'servicefabric/resource-manager', tags: [ 'schema-servicefabric-2016-09-01', 'schema-servicefabric-2017-07-01-preview', 'schema-servicefabric-2018-02-01', 'schema-servicefabric-2019-03-01', 'schema-servicefabric-2019-03-01-preview', 'schema-servicefabric-2019-06-01-preview' ]},
